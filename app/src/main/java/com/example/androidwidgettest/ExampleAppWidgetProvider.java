...
public class ExampleAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onEnabled(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            context.startForegroundService(new Intent(context,  ExampleAppWidgetService.class));
        } else {
            context.startService(new Intent(context, ExampleAppWidgetService.class));
        }
    ...
    public void onDisabled(Context context) {
        ...
        context.stopService(new Intent(context, ExampleAppWidgetService.class));
    ...
    private void prtSet() {
        if (DEBUG) {
            ...
            while (it.hasNext()) {
                Log.d(TAG, " -- " + ((Integer) it.next()).intValue());
            }
        }
    }
